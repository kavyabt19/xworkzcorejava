...
public class ParkerTester {
		...
		public static void main(String[] args) {
			...
			System.out.println(m.bitCount(Banglorepin));
			System.out.println(m.reverse(falt));
			System.out.println(m.divideUnsigned(iphone, ipod));
			
			System.out.println(m.lowestOneBit(falt));
			System.out.println(m.toBinaryString(iphone));
			System.out.println(m.toHexString(Banglorepin));
			...
			char icon = 'a';
			Character iconq = new Character('a');
			System.out.println(iconq.charCount(icon));
			System.out.println(iconq.isTitleCase(icon));
		    System.out.println(iconq.isLetter(icon));
		    System.out.println(iconq.isUnicodeIdentifierPart(icon));
